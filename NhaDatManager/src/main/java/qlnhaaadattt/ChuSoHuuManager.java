...
public class ChuSoHuuManager extends javax.swing.JFrame {
    ...
    public void ShowProfile() {
        String[] arr = {
            "Mã chủ sở hữu", "Tên chủ sở hữu", "Số thửa", "ngày sở hữu "
        };
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Date ngaySoHuu = rs.getDate("ngaysohuu");
                a.setNgaySoHuu(ngaySoHuu.toLocalDate());
    ...
    public void UpdateDat(ChoSoHuu x) {
        if (row >= 0 && row < qlchusohuu.size()) {
            qlchusohuu.set(row, x);
            ShowProfile();
        } else {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (maCSH.equals("") || tenCSH.equals("") || soThua.equals("") || ngaySoHuu.equals("")) {
            Label lbErr = new Label();
            lbErr.setText("*Khong duoc de trong");
        } else {
            ChuSoHuuDAO dao = new ChuSoHuuDAO();
            ChoSoHuu x = new ChoSoHuu(Integer.parseInt(maCSH), tenCSH, Integer.parseInt(soThua),LocalDate.parse(ngaySoHuu));
//
            if (dao.update(x) == 1) {
                qlchusohuu.remove(row);
                UpdateDat(x);
    ...
    private void tbCSHMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbCSHMousePressed
        ...
        String ngaySoHuu = tbCSH.getModel().getValueAt(row, 3).toString();
        
        txtMaCSH.setText(maCSH);
        txtName.setText(tenCSH);
        txtSoThua.setText(soThua);
        txtNgaySoHuu.setText(ngaySoHuu);
